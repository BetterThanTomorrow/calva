...
* `projectType`: (required) This is either "Leiningen", "deps.edn", "shadow-cljs", "lein-shadow", "Gradle", "babashka", "nbb", "basilisp", "joyride", "generic", "clj-projectless", "custom", or "cljs-only".
