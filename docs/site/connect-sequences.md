...
* `jackInEnv`: An object with environment variables that will be added to the environment of the Jack-in process. Will overwrite keys set at the global `calva.jackInEnv`.
