...
<kbd>ctrl</kbd> <kbd>alt</kbd> <kbd>t</kbd>                        | **Transpose Sexps/Forms** | Swaps place of the two forms surrounding the cursor. <br> ![](_static/images/paredit/transpose.gif)
<kbd>ctrl</kbd> <kbd>alt</kbd> <kbd>shift</kbd> <kbd>l</kbd><br><kbd>ctrl</kbd> <kbd>alt</kbd> <kbd>shift</kbd> <kbd>r</kbd> | **Push Sexp/Form Left/Right** | Moves the current form to the left/right of the previous/next one. <br> ![](_static/images/paredit/left-right.gif)
