...
function initializeState() {
    ...
    setStateValue(
        'outputChannel',
        vscode.window.createOutputChannel('Calva says')
    );
    setStateValue(
...
async function activate(context: vscode.ExtensionContext) {
    ...
    const pareEditExtension = vscode.extensions.getExtension(
        'cospaia.paredit-revived'
    );
    const cwExtension = vscode.extensions.getExtension(
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('calva.jackIn', jackIn.jackInCommand)
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand(
            'calva.disconnect',
            jackIn.calvaDisconnect
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
            'calva.toggleCLJCSession',
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand(
            ...
            connector.switchCljsBuild
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
            'calva.selectCurrentForm',
            select.selectCurrentForm
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand('calva.loadFile', async () => {
            await eval.loadFile({}, config.getConfig().prettyPrintingOptions);
            return new Promise((finished) => {outputWindow.appendPrompt(finished)});
        })
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
            'calva.interruptAllEvaluations',
            eval.interruptAllEvaluations
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
            'calva.evaluateSelection',
            eval.evaluateCurrentForm
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
            'calva.evaluateEnclosingForm',
            eval.evaluateEnclosingForm
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
            'calva.evaluateToCursor',
            eval.evaluateToCursor
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand(
            ...
            eval.evaluateTopLevelForm
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
            'calva.evaluateOutputWindowForm',
            eval.evaluateOutputWindowForm
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
            'calva.evaluateSelectionReplace',
            eval.evaluateSelectionReplace
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand(
            'calva.togglePrettyPrint',
            eval.togglePrettyPrint
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand(
            ...
            eval.copyLastResultCommand
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
            'calva.requireREPLUtilities',
            eval.requireREPLUtilitiesCommand
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand('calva.refresh', refresh.refresh)
    );
    context.subscriptions.push(
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand(
            'calva.debug.instrument',
            eval.instrumentTopLevelForm
        )
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(
    ...
    context.subscriptions.push(
        vscode.workspace.onDidChangeTextDocument(
            annotations.onDidChangeTextDocument
        )
    );
    context.subscriptions.push(
