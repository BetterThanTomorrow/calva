...
import paredit from './paredit/extension';
import fmt from './calva-fmt/src/extension';
import highlight from './highlight/src/extension';
import state from './state';
import jackIn from './nrepl/jack-in';
import replStart from './nrepl/repl-start';
