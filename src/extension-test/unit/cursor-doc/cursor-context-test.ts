...
describe('Cursor Contexts', () => {
    ...
    describe('cursorInComment', () => {
        ...
        it('is false in symbol', () => {
            const contexts = context.determineContexts(docFromTextNotation(';; foo •   ;; bar•  ;; baz  •g|az   ;;  '));
    ...
    describe('cursorBeforeComment', () => {
        it('is false in comment', () => {
            const contexts = context.determineContexts(docFromTextNotation(';; fo|o•   ;; bar•  ;; baz  •gaz'));
