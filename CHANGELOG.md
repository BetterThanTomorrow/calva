...
- [Remove the display diagnostics setting in favor of the user managing diagnostics entirely via clojure-lsp config](https://github.com/BetterThanTomorrow/calva/issues/1067)
