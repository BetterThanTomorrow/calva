---
description: 'Smoke testing patterns and best practices for Calva extension development.'
applyTo: '**/src/extension-test/smoke-test,package.json'
---
...
- Use exact CI argument reproduction: `npm run smoke-test-containerized -- --ci`
