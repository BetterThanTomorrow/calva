...
_NB: Some project setups do not lend themselves to Jack-in, but Calva might still be able to connect. See [Connecting to a running REPL server](/wiki/Connecting-To-a-Running-REPL-Server)_. 
